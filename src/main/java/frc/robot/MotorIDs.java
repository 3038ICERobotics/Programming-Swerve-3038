...
public class MotorIDs {
    public static int FrontLeftDriveID = 2;
    public static int FrontLeftSteerID = 3;
    public static int FrontRightDriveID = 4;
    public static int FrontRightSteerID = 5;
    public static int BackLeftDriveID = 6;
    public static int BackLeftSteerID = 7;
